        ...
        try:
            ...
            if (
                (road_cords_number%2==0 and cords>=50 and cords<=window.winfo_screenwidth()-50)
                  or 
                (road_cords_number%2==1 and cords>=290 and cords<=window.winfo_screenheight()-50)) and road_cords_ok==1:
                text_road.delete(0, tk.END)
...
def start_car(canvas,root):
    ...
    x,y=path_points[0]
    ground=[(root.winfo_screenwidth()-21,y_end),(root.winfo_screenwidth()-21,root.winfo_screenheight()-31),
            (22,root.winfo_screenheight()-31),(21,y)]+path_points
...
def cim_home():
    ...
    cim.place(x=screen_width/10.4,y=10)
def gombok():
